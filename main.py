...
BG = pygame.transform.scale(pygame.image.load("dark.png"), (WIDTH, HEIGHT))
...
def draw(player, elapsed_time, stars):
    ...
    score_text = FONT.render(f"Score: {round(elapsed_time * 10)}", 1, "white")
    WIN.blit(score_text, (10, 50))

    pygame.display.update()


def draw_end_screen(elapsed_time):
    WIN.blit(BG, (0, 0))
